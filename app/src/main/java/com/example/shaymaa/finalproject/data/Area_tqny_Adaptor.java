...
public class Area_tqny_Adaptor  extends RecyclerView.Adapter<Area_tqny_Adaptor.ViewHolder> {
    private ArrayList<Area_tqny_data> androidList;
    private Context context;
    private int lastPosition=-1;
    String city_name ,factory_space, factory_title;


    public Area_tqny_Adaptor(ArrayList<Area_tqny_data> android,Context c) {
        this.androidList = android;
        this.context=c;
    }

    @Override
    public Area_tqny_Adaptor.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.  industrial_cities_row, viewGroup, false);


        return new Area_tqny_Adaptor.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(Area_tqny_Adaptor.ViewHolder viewHolder, final int i) {
