...
public class DetalisOfProduction_WitRemove extends AppCompatActivity {
    ImageView go_back;
    Bundle bundle;
 String image_name,title,price,discount,discount_date,content,freight,service,method,close;
    MyTextView product_title,product_price,product_discount,product_discount_date,product_content,
            product_freight,product_service,product_method,titel,remove_from_my_fav;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalis_of_production);
...
//        product_title=(MyTextView)findViewById(R.id.product_title);
        ...
        remove_from_my_fav=(MyTextView)findViewById(R.id.remove_from_my_fav);
        ...
        remove_from_my_fav.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                removeFromAdd(id,idi);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int n = 0; n < company.length(); n++) {
                        ...
                        Picasso.with(DetalisOfProduction_WitRemove.this).load(imageUr).error(android.R.drawable.stat_notify_error).fit().into(product_image_name);
...
//                        data= new Folwers_Data(object.getString("user_id"),object.getString("username"),object.getString("date_insert"));
    ...
    private void removeFromAdd(final String user_id , final String product_id)
    {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, myUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(DetalisOfProduction_WitRemove.this,response,Toast.LENGTH_LONG).show();
...
//                        Toast.makeText( RegistrationUser.this, "this error",Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DetalisOfProduction_WitRemove.this,"errrrorrr",Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
